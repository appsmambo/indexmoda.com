...
@endif
		...
		<script src="{{ url() }}/js/jquery.video-background.min.js"></script>
		...
		<script src="{{ url() }}/js/animaciones.js?ver=1.1"></script>
		<script>
	...
	<body>
		...
		<div id="wrapper">
			...
			<header>
				...
				<a href="https://www.facebook.com/indexperu" target="_blank"><img src="{{ url() }}/img/icon-facebook.png" alt="" class="img-responsive icon-menu"></a>
				<a href="http://instagram.com/indexperu/" target="_blank"><img src="{{ url() }}/img/icon-instagram.png" alt="" class="img-responsive icon-menu"></a>
			...
			<div class="rcWrapper">
				<ul>
					<li class="fullscreen-video-pelotas">
								...
								<div class="row hidden-xs">
									<div class="col-sm-offset-1 col-sm-10">
										<div class="row">
											<div class="col-sm-6">
												<div class="row">
													<div class="col-sm-11 col-md-11 col-lg-offset-2 col-lg-8">
														<p class="diviertete">
															<br><br><span class="hidden-sm hidden-md"><br><br></span>
											...
											<div class="col-sm-6">
												<img class="img-responsive center-block" src="{{ url() }}/img/chicas-index.png" alt="">
											</div>
										</div>
									</div>
								</div>
		...
		<div id="catalogo" style="display:none">
			<div data-configid="7354832/11299613" style="width:100%; height:600px;" class="issuuembed"></div><script type="text/javascript" src="//e.issuu.com/embed.js" async="true"></script>
		</div>
		...
		<div class="bloque" id="casaca-moto-vestido-funky" style="display:none">
			...
			<div class="degrade pull-right">
				<p class="datos">
					casaca moto<br>
					<strong>S/.99.90</strong> - <small>16306362</small><br><br>
					vestido funky<br>
		...
		<div class="bloque" id="chompa-parky-jean-brito" style="display:none">
			...
			<div class="degrade pull-right">
				<p class="datos">
					chompa parky<br>
					<strong>S/. 159</strong> - <small>16306133</small><br><br>
					jean brito<br>
        ...
        <div class="bloque" id="blazer-long-polo-boy-short-rice" style="display:none">
            ...
            <div class="degrade pull-right">
                <p class="datos">
                    blazer long<br>
                    <strong>S/. 129</strong> - <small>16398334</small><br><br>
                    polo boy<br>
                    <strong>S/. 39.90</strong> - <small>16537712</small><br><br>
                    short rice<br>
		...
		<div class="bloque" id="camisa-gamuza-falda-midi" style="display:none">
            ...
            <div class="degrade pull-right">
                <p class="datos">
                    camisa gamuza<br>
                    <strong>S/. 179</strong> - <small>16608874</small><br><br>
                    falda midi<br>
        ...
        <div class="bloque" id="chompa-longy-falda-tubo" style="display:none">
            ...
            <div class="degrade pull-right">
                <p class="datos">
                    chompa longy<br>
                    <strong>S/. 69.90</strong> - <small>16610232</small><br><br>
                    falda tubo<br>
        ...
        <div class="bloque" id="polo-crop-leggins-textu" style="display:none">
            ...
            <div class="degrade pull-right">
                <p class="datos">
                    polo crop<br>
                    <strong>S/. 39.90</strong> - <small>16290493</small><br><br>
                    leggins textu<br>
        ...
        <div class="bloque" id="chompa-grandma-vestido-led" style="display:none">
            ...
            <div class="degrade pull-right">
                <p class="datos">
                    chompa grandma<br>
                    <strong>S/. 99.90 </strong> - <small>166507443</small><br><br>
                    vestido led<br>
        ...
        <div class="bloque" id="chompa-moti-polo-crop-short-rice" style="display:none">
            ...
            <div class="degrade pull-right">
                <p class="datos">
                    chompa moti<br>
                    <strong>S/. 69.90 </strong> - <small>16508867</small><br><br>
                    polo crop<br>
                    <strong>S/. 39.90 </strong> - <small>16290493</small><br><br>
                    short rice<br>
                    <strong>S/. 79.90 </strong> - <small>16680791</small>
